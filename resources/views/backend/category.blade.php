                ...
                <div class="col-12">
                    <div class="card mb-30">
                        <div class="card-body pt-30">
                            <h4 class="font-20 ">Category List</h4>
                ...
                <form id="form-tambah" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-4">
                            <label for="imdb_id" class="mb-2 bold">Category Name</label>
                            <input type="text" class="theme-input-style" id="category_name" name="category_name"
