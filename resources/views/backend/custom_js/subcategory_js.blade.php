@if ($view == 'subcategory')
    <script>
        ...
        $("#form-tambah").submit(function(e) {
            ...
            e.preventDefault();
            var id = $('#id').val();
            if (save_method == "add") url = "{{ url('/mvadmin/subcategory') }}";
            else url = "{{ url('/mvadmin/subcategory') . '/' }}" + id;
        ...
        function editData(id) {
            ...
            $.ajax({
                url: "{{ url('/mvadmin/subcategory') }}" + "/" + id + "/edit",
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    $('#modal-tambah').modal("show");
        ...
        function deleteData(id) {
            ...
            if (pop === true) {
                $.ajax({
                    url: "{{ url('mvadmin/subcategory') }}" + "/" + id,
                    type: "DELETE",
                    dataType: "JSON",
