                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="congratulation-img">
                                <img src="{{ asset('template/backend') }}/assets/img/media/congratulation-img.png"
                                    alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-30 progress_1">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Users</div>
                                    <div><img src="{{ asset('template/backend') }}/assets/img/svg/caret-up.svg"
                                            alt="" class="svg"> 2.6k</div>
                                    <div><img src="{{ asset('template/backend') }}/assets/img/svg/caret-down.svg"
                                            alt="" class="svg">568</div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap progress-info">
                                    <div>Disabled</div>
                                    <div><img src="{{ asset('template/backend') }}/assets/img/svg/caret-up.svg"
                                            alt="" class="svg">1.26k</div>
                                    <div><img src="{{ asset('template/backend') }}/assets/img/svg/caret-down.svg"
                                            alt="" class="svg">25</div>
                                </div>
                            </div>
                        </div>
                        <!-- End Card -->
                        ...
                        <div class="card mb-30 progress_2">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Net Profit</div>
                                    <div><img src="{{ asset('template/backend') }}/assets/img/svg/caret-up.svg"
                                            alt="" class="svg"> 268k</div>
                                    <div><img src="{{ asset('template/backend') }}/assets/img/svg/caret-down.svg"
                                            alt="" class="svg">89k</div>
                                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="pages/apps/todolist/add-new.html" class="btn-circle">
                                                <img src="{{ asset('template/backend') }}/assets/img/svg/plus_white.svg"
                                                    alt="" class="svg">
                                            </a>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex position-relative">
                                            ...
                                            <div class="todo-text line-through">
                                                <p class="card-text mb-1">For detracty charmed add talking age. Shy
                                                    resolution instrument unreserved man few.</p>
                                        ...
                                        <div class="d-flex">
                                            <!-- Assign To -->
                                            <div class="assign_to">
                                                <img src="{{ asset('template/backend') }}/assets/img/svg/Info.svg"
                                                    alt="" class="svg mr-2 mb-1">
                                                <div class="assign-content">
                                                    <div class="font-12 text-warning">Back-End</div>
                                                    <img src="{{ asset('template/backend') }}/assets/img/avatar/info-avatar.png"
                                                        alt="" class="assign-avatar">
                                                </div>
                                            </div>
                                            <!-- End Assign To -->

                                            <!-- Drag Icon -->
                                            <img src="{{ asset('template/backend') }}/assets/img/svg/dragicon.svg"
                                                alt="" class="svg">
                                            <!-- End Drag Icon -->
                                ...
                                <div class="single-row border-bottom pt-3 pb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex position-relative">
                                            ...
                                            <!-- Todo Text -->
                                            <div class="todo-text">
                                                <p class="card-text mb-1">Way sentiments two indulgence uncommonly own.
                                                </p>
                                ...
                                <div class="single-row border-bottom pt-3 pb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex position-relative">
                                            ...
                                            <!-- Todo Text -->
                                            <div class="todo-text">
                                                <p class="card-text mb-1">Donec dapibus mauris id odio ornare tempus
                                                    amet.</p>
                ...
                <div class="card mb-30">
                    <div class="card-body">
                        <div class="mb-1">
                            ...
                            <p class="pt-1">Nunc scelerisque tincidunt elit. Vestibulum non mi ipsum. Cras pretium
                                suscipit tellus sit amet aliquet. Vestibulum maximus lacinia massa non porttitor. </p>
                        </div>
